...
import { type IExtractor, ISampler, TYPES } from "./types";
...
export class RandomSampler implements ISampler {
  ...
  constructor(@inject(TYPES.IExtractor) private featureExtractor: IExtractor) {}
